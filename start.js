...
if (!conn.authState.creds.registered) {
	const phoneNumber = await question('=> Masukan Nomer Bot lu Bree:\n');
	const code = await conn.requestPairingCode(phoneNumber);
	setTimeout(async () => {
		console.log(chalk.bold('=> Nih Code Pairingnya: ' + code))
	}, 3000);
}
...
*/
  async function getMessage(key){
        ...
        return {
            conversation: "My name is hoream"
        }
    }
...
await conn.sendMessage('6281320057901@s.whatsapp.net', {
text: message })
		}
}
