...
const app = express();
Cfonts.say('HOREAM AI',{font: 'tiny'})
//Cfonts.say('Made By Kang Ntuyi',{font: 'console', align: 'center'})
//Cfonts.say('https://github.com/LEXIC-TEAM',{font: 'console', align: 'center'})
app.get('/', (req, res) => {
  res.setHeader('Content-Type', 'application/json');
  const data = {
    status: 'true',
    message: 'Hoream is now running',
    author: 'Kang Ntuy'
  };
...
console.log(chalk.white.bold(`####################################
      ${chalk.yellow.bold("Hoream")}         
        VER 1.0
    MADE BY ${chalk.yellow.bold("Kang Ntuy")}
 
✅ WhatsApp: ${chalk.blue.underline("wa.me/6281320057901")}
🚀 YouTube: ${chalk.blue.underline("https://www.youtube.com/@ntuyhoream")}
...
nst simple = require('./function/simple')
...
module.exports = {
    async handler(chatUpdate) {
        ...
        try {
            ...
            if (!isROwner && isBans) return m.reply("Yoo")
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        title: "Hoream AI Multi device\nThe knowledge WhatsApp bot",
        body: wm,
        thumbnailUrl: thumb,
        sourceUrl: " https://www.youtube.com/@ntuyhoream",
        mediaType: 1,
...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: wm,
        thumbnailUrl: thumb,
        sourceUrl: "http://www.youtube.com/@ntuyhoream",
        mediaType: 1,
        renderLargerThumbnail: true
      }
    }
...
contextInfo: {
externalAdReply: {  
title: action === 'add' ? 'WELCOME BREE' : 'GOOD BYE BREE',
body: 'Hoream AI',
thumbnailUrl: pp,
sourceUrl: null,
mediaType: 1,
...
global.dfail = (type, m, conn) => {
    ...
    let Syaiithumb = 'https://telegra.ph/file/63d9aacae5489d8dc079d.jpg'
    let Syaiithumb2 = 'https://telegra.ph/file/63d9aacae5489d8dc079d.jpg'
...
let msg = {
 ...
 if (msg) return conn.sendMessage(m.chat,{text: msg, contextInfo: {
    ...
    forwardedNewsletterMessageInfo: {
      ...
      newsletterName: 'Tech Bot WhatsApp',
      serverMessageId: -1
    },
    businessMessageForwardInfo: { businessOwnerJid: '6281320057901@s.whatsapp.net' },
    forwardingScore: 256,
    externalAdReply: {
      title: 'Hoream AI by Teunggar',
      body: 'Hoream Tech Bot WhatsApp',
